...
const PORT_INF AD_TEMP3_COM = {GPIOA, GPIO_Pin_2};
const PORT_INF AD_TEMP4_COM = {GPIOA, GPIO_Pin_3};
const PORT_INF AD_TEMP5_COM = {GPIOA, GPIO_Pin_4};
const PORT_INF AD_TEMP6_COM = {GPIOA, GPIO_Pin_5};
void AD_InitInterface(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = AD_TEMP3_COM.Pin;
    GPIO_Init(AD_TEMP3_COM.Port, &GPIO_InitStructure);
    
    GPIO_InitStructure.GPIO_Pin = AD_TEMP4_COM.Pin;
    GPIO_Init(AD_TEMP4_COM.Port, &GPIO_InitStructure);
    
    GPIO_InitStructure.GPIO_Pin = AD_TEMP5_COM.Pin;
    GPIO_Init(AD_TEMP5_COM.Port, &GPIO_InitStructure);
    
    GPIO_InitStructure.GPIO_Pin = AD_TEMP6_COM.Pin;
    GPIO_Init(AD_TEMP6_COM.Port, &GPIO_InitStructure);
}
...
void AD_Init(void)
{
    ...
    ADC_RegularChannelConfig(AD_PORT, AD_TEMP3_CHANNEL, 3, AD_TIME);
    ADC_RegularChannelConfig(AD_PORT, AD_TEMP4_CHANNEL, 4, AD_TIME);
    ADC_RegularChannelConfig(AD_PORT, AD_TEMP5_CHANNEL, 5, AD_TIME);
    ADC_RegularChannelConfig(AD_PORT, AD_TEMP6_CHANNEL, 6, AD_TIME);
...
//    if(num & 0x01)
//    {
//        AD_SEL0_COM.Port->BSRR = AD_SEL0_COM.Pin;
//    }
//    else
//    {
//        AD_SEL0_COM.Port->BRR = AD_SEL0_COM.Pin;
//    }
//    
//    if(num & 0x02)
//    {
//        AD_SEL1_COM.Port->BSRR = AD_SEL1_COM.Pin;
//    }
//    else
//    {
//        AD_SEL1_COM.Port->BRR = AD_SEL1_COM.Pin;
//    }
//}